...
# python dataset_toolkits/build_metadata.py $dataset_name --split dense --output_dir $data_dir

# python dataset_toolkits/download.py $dataset_name  --split dense --output_dir $data_dir
...
# python dataset_toolkits/render.py $dataset_name --output_dir $data_dir --radius 1.5 --num_views 0
