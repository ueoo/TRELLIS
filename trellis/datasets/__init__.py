...
__attributes = {
    ...
    "MultiImageResampleConditionedSparseStructureLatent": "sparse_structure_latent",
    ...
    "MultiImageResampleConditionedSLat": "structured_latent",
...
if __name__ == "__main__":
    ...
    from .sparse_structure_latent import (
        ...
        MultiImageResampleConditionedSparseStructureLatent,
    ...
    from .structured_latent import (
        ...
        MultiImageResampleConditionedSLat,
