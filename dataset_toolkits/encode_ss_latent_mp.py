...
def launch_encode_ss_latent_jobs(args):
    ...
    for gpu_idx in gpu_ids:
        ...
        cmd = (
            f"export {env} {cpu_env} && python dataset_toolkits/encode_ss_latent.py "
            f"--output_dir {shlex.quote(args.output_dir)} "
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--enc_pretrained", type=str, default="microsoft/TRELLIS-image-large/ckpts/ss_enc_conv3d_16l8_fp16"
    )
    ...
    launch_encode_ss_latent_jobs(args)
