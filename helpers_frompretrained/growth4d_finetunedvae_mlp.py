...
our_finetune_folder = "TRELLIS-image-large-growth4d-finetunedvae-mlp"
...
rename_ops = {
    ...
    "sparse_structure_cond_sparse_structure_flow_model": "ss_flow_ssprev_dit_L_16l8_fp16_finetune_finetunedvae_mlp_growth4d",
...
model_name_to_ckpt = {
    ...
    "slat_decoder_gs": "decoder_ema0.9999_step0360000.pt",
