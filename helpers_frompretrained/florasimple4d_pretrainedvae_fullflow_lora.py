...
our_finetune_folder = "TRELLIS-image-large-florasimple4d-pretrainedvae-fullflow-lora-10k"

# Map model keys to their LoRA training run directories
rename_ops = {
    "sparse_structure_decoder": "copy",
    "sparse_structure_flow_model": "ss_flow_img_all_dit_pretrainedvae_lora_florasimple4d",
    ...
    "slat_flow_model": "slat_flow_img_all_dit_pretrainedvae_lora_florasimple4d",
...
model_name_to_ckpt = {
    ...
    "sparse_structure_cond_sparse_structure_flow_model": "denoiser_step0010000.pt",
    "slat_flow_model": "denoiser_step0010000.pt",
    "slat_cond_slat_flow_model": "denoiser_step0010000.pt",
}
