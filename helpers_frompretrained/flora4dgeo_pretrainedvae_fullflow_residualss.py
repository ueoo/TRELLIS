...
our_finetune_folder = "TRELLIS-image-large-flora4dgeo-pretrainedvae-fullflow-residualss"

rename_ops = {
    "sparse_structure_decoder": "copy",
    "sparse_structure_flow_model": "ss_flow_img_dit_pretrainedvae_flora125geo",
    "sparse_structure_cond_sparse_structure_flow_model": "ss_residual_flow_ssprev_dit_L_16l8_fp16_pretrainedvae_every_flora125geo",
...
model_name_to_ckpt = {
    ...
    "sparse_structure_cond_sparse_structure_flow_model": "denoiser_step0530000.pt",
    "slat_flow_model": "denoiser_step0560000.pt",
    "slat_cond_slat_flow_model": "denoiser_step0780000.pt",
}
