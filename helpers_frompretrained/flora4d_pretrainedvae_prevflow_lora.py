...
our_finetune_folder = "TRELLIS-image-large-flora4d-pretrainedvae-prevflow-lora"
...
model_name_to_ckpt = {
    # "sparse_structure_flow_model": "denoiser_step0200000.pt",
    "sparse_structure_cond_sparse_structure_flow_model": "denoiser_step0200000.pt",
    # "slat_flow_model": "denoiser_step0200000.pt",
    "slat_cond_slat_flow_model": "denoiser_step0200000.pt",
}
