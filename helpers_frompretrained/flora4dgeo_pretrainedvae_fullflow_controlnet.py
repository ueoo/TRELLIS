...
our_finetune_folder = "TRELLIS-image-large-flora4dgeo-pretrainedvae-fullflow-controlnet"

rename_ops = {
    "sparse_structure_decoder": "copy",
    "sparse_structure_flow_model": "ss_flow_img_dit_pretrainedvae_flora125geo",
    "sparse_structure_cond_sparse_structure_flow_model": "ss_controlnet_flow_ssprev_dit_L_16l8_fp16_pretrainedvae_flora125geo",
    "slat_decoder_gs": "copy",
    "slat_flow_model": "slat_flow_img_dit_pretrainedvae_flora125geo",
    "slat_cond_slat_flow_model": "slat_controlnet_flow_slatprev_dit_L_64l8p2_fp16_pretrainedvae_flora125geo",
}

model_name_to_ckpt = {
    "sparse_structure_flow_model": "denoiser_step0350000.pt",
    "sparse_structure_cond_sparse_structure_flow_model": "denoiser_step0390000.pt",
    "slat_flow_model": "denoiser_step0560000.pt",
    "slat_cond_slat_flow_model": "denoiser_step0610000.pt",
}
