...
our_finetune_folder = "TRELLIS-image-large-flora4d-pretrainedvae-fullflow-mlp"


# Map model keys to their LoRA training run directories
rename_ops = {
    "sparse_structure_decoder": "copy",
    "sparse_structure_flow_model": "ss_flow_img_all_dit_pretrainedvae_mlp_flora4d",
    "sparse_structure_cond_sparse_structure_flow_model": "ss_flow_ssprev_dit_pretrainedvae_mlp_flora4d",
    "slat_decoder_gs": "copy",
    "slat_flow_model": "slat_flow_img_all_dit_pretrainedvae_mlp_flora4d",
    "slat_cond_slat_flow_model": "slat_flow_slatprev_dit_pretrainedvae_mlp_flora4d",
}
