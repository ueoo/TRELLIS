...
selected_test_cond_frames = [
    "flowerfinal_0001/010.png",
    "jmfloraorchidstemg_0001/000.png",
    "whitemushroom_0001/001.png",
]

train_data_root = "/scr/yuegao/TRELLIS_datasets/Growth4D_train"
selected_train_cond_frames = [
    # "makeaflower1001_0001/011.png",
    "kinefx101bouquet1_0001/010.png",
    # "mushroom_0040/010.png",
]


test_cond_frame_paths = [
    os.path.join(test_data_root, "renders_cond", cond_frame_name) for cond_frame_name in selected_test_cond_frames
]

train_cond_frame_paths = [
    os.path.join(train_data_root, "renders_cond", cond_frame_name) for cond_frame_name in selected_train_cond_frames
]
...
for cond_frame_path in cond_frame_paths:
    ...
    output_folder = os.path.join(results_root, f"results_growth4d{finetune_name.replace('-', '_')}_renders_cond")
